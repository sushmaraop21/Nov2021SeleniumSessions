...
public class TotalLinks {
	...
	public static void main(String[] args) {
		...
		// 3.print the href calue of each link
...
//		System.out.println("Total links: " + linksList.size()); // 413
////			int c=0;
...
//		}
		...
		//System.out.println(getElementTextList(links)); //elements text is given here
...
//		System.out.println(getElementAttributeList(images,"alt"));
//		System.out.println(getElementAttributeList(links, "href"));
